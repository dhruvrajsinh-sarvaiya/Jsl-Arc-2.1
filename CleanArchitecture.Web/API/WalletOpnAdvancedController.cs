...
namespace CleanArchitecture.Web.API
{
    ...
    public class WalletOpnAdvancedController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet("{coin}/{id}")]
        public Task<IActionResult> ListWalletAddress(string coin,string id, int sortOrder=-1, int limit=25,string prevId=null, string labelContains=null)
        {
        ...
        /// <returns></returns>
        [HttpGet("{coin}/{id}")]
        public Task<IActionResult> ListWalletTransaction(string coin, string id,string prevId=null,bool allTokens=false)
        {
        ...
        public Task<IActionResult> GetWalletTransaction(string coin, string id,string txid)
        {
        ...
        /// <returns></returns>
        [HttpGet("{coin}")]
        public Task<IActionResult> GetFirstPendingTransaction(string coin,string enterpriseId=null,string walletId=null)
        {
        ...
        /// <returns></returns>
        [HttpPost("{coin}/{id}")]
        public Task<IActionResult> ChangeFeeonTransaction(string coin, string id,[FromBody]ChangeFeeonTransactionRequest Request)
        {
        ...
        /// <returns></returns>
        [HttpGet("{coin}/{id}")]
        public Task<IActionResult> ListWalletUnspents(string coin, string id,int? minValue,int? maxValue,int? minHeight,int? minConfirms,string prevId= null)
        {
        ...
        /// <returns></returns>
        [HttpGet("{coin}")]
        public Task<IActionResult> GetTotalBalances(string coin)
        {
        ...
        /// <returns></returns>
        [HttpGet("{coin}/{id}")]
        public Task<IActionResult> GetMaximumSpendable(string coin, string id, int? limit, int? minValue, int? maxValue, int? minHeight, int? feeRate, int? maxFeeRate, int? minConfirms, bool enforceMinConfirmsForChange = false)
        {
        ...
        /// <returns></returns>
        [HttpPost("{coin}/{id}")]
        public Task<IActionResult> ConsolidateWalletUnspents(string coin, string id,[FromBody]ConsolidateWalletUnspentsRequest Request)
        {
        ...
        /// <returns></returns>
        [HttpPost("{coin}/{id}")]
        public Task<IActionResult> FanoutWalletUnspents(string coin, string id,[FromBody]FanoutWalletUnspentsRequest Request)
        {
            string requeststring = "{'txid':'5885a7e6c7802206f69655ed763d14f101cf46501aef38e275c67c72cfcedb75','tx':'010000001945f506cad0d2b8be8e36ed5d4dbb7502cd3a2822d01f7afe411f9773c6fd381cad0 ...','status':'signed'}";
        ...
        /// <returns></returns>
        [HttpPost("{coin}/{id}")]
        public Task<IActionResult> Sweep(string coin, string id,[FromBody]SweepRequest Request)
        {
            string requeststring = "{'txid':'5885a7e6c7802206f69655ed763d14f101cf46501aef38e275c67c72cfcedb75','tx':'010000001945f506cad0d2b8be8e36ed5d4dbb7502cd3a2822d01f7afe411f9773c6fd381cad0 ...','status':'signed'}";
        ...
        /// <returns></returns>
        [HttpPost("{coin}/{id}")]
        public Task<IActionResult> BuildTransaction(string coin, string id,[FromBody]BuildTransactionRequest Request)
        {
