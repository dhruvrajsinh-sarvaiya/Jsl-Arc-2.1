...
namespace CleanArchitecture.Web.API
{
    ...
    public class WalletOpnAdvancedController : Controller
    {
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("ListWalletTransaction")]
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("GetFirstPendingTransaction")]
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("ChangeFeeonTransaction")]
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("ListWalletUnspents")]
        public ActionResult ListWalletUnspents([FromBody]ListWalletUnspentsRequest Request)
        {
        ...
        public ActionResult GetTotalBalances(GetTotalBalancesRequest Request)
        {
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("GetMaximumSpendable")]
        public ActionResult GetMaximumSpendable([FromBody]GetMaximumSpendableRequest Request)
        {
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("ConsolidateWalletUnspents")]
        public ActionResult ConsolidateWalletUnspents([FromBody]ConsolidateWalletUnspentsRequest Request)
        {
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("FanoutWalletUnspents")]
        public ActionResult FanoutWalletUnspents([FromBody]FanoutWalletUnspentsRequest Request)
        {
            string requeststring = "{'txid':'5885a7e6c7802206f69655ed763d14f101cf46501aef38e275c67c72cfcedb75','tx':'010000001945f506cad0d2b8be8e36ed5d4dbb7502cd3a2822d01f7afe411f9773c6fd381cad0 ...','status':'signed'}";
        ...
        /// <returns></returns>
        [HttpPost("Sweep")]
        public ActionResult Sweep([FromBody]SweepRequest Request)
        {
            string requeststring = "{'txid':'5885a7e6c7802206f69655ed763d14f101cf46501aef38e275c67c72cfcedb75','tx':'010000001945f506cad0d2b8be8e36ed5d4dbb7502cd3a2822d01f7afe411f9773c6fd381cad0 ...','status':'signed'}";
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("BuildTransaction")]
        public ActionResult BuildTransaction([FromBody]BuildTransactionRequest Request)
        {
