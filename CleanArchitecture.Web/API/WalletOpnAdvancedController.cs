...
namespace CleanArchitecture.Web.API
{
    ...
    public class WalletOpnAdvancedController : Controller
    {
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("Get Maximum Spendable")]
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("Consolidate Wallet Unspents")]
        ...
        /// <param name="Request"></param>
        /// <returns></returns>
        [HttpPost("Fanout Wallet Unspents")]
