...
namespace CleanArchitecture.Core.Interfaces
{
    ...
    {
        Task<string> SendEmailAsync(string Email, string Recepient, string Subject, string BCC,string CC, string Body, string Url, string UserID, string Password,int Port);
